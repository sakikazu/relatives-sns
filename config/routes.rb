...
#                      mobile_sign_out DELETE /m/sign_out(.:format)                                                                    devise/sessions#destroy
...
#                   index_mobile_blogs GET    /blogs/index_mobile(.:format)                                                            blogs#index_mobile
#                everyone_mobile_blogs GET    /blogs/everyone_mobile(.:format)                                                         blogs#everyone_mobile
#                    show_mobile_blogs GET    /blogs/show_mobile(.:format)                                                             blogs#show_mobile
#                     new_mobile_blogs GET    /blogs/new_mobile(.:format)                                                              blogs#new_mobile
#                    edit_mobile_blogs GET    /blogs/edit_mobile(.:format)                                                             blogs#edit_mobile
# destroy_comment_confirm_mobile_blogs GET    /blogs/destroy_comment_confirm_mobile(.:format)                                          blogs#destroy_comment_confirm_mobile
#         destroy_confirm_mobile_blogs GET    /blogs/destroy_confirm_mobile(.:format)                                                  blogs#destroy_confirm_mobile
...
#                      destroy_comment DELETE /blogs/destroy_comment/:id(.:format)                                                     blogs#destroy_comment
...
#         create_comment_mobile_boards POST   /boards/create_comment_mobile(.:format)                                                  boards#create_comment_mobile
#                  index_mobile_boards GET    /boards/index_mobile(.:format)                                                           boards#index_mobile
#                    show_mobile_board GET    /boards/:id/show_mobile(.:format)                                                        boards#show_mobile
...
#                            he_others GET    /others/he(.:format)                                                                     others#he
