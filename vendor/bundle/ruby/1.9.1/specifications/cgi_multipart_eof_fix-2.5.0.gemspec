...
Gem::Specification.new do |s|
  ...
  s.date = "2007-10-26"
  s.description = "Fix an exploitable bug in CGI multipart parsing."
  s.email = ""
  s.homepage = "http://blog.evanweaver.com/pages/code#cgi_multipart_eof_fix"
  s.require_paths = ["lib"]
  s.rubyforge_project = "mongrel"
  s.rubygems_version = "1.8.24"
  s.summary = "Fix an exploitable bug in CGI multipart parsing."
